...
if __name__ == '__main__':
    ...
    train_loader = torch.utils.data.DataLoader(trainset, batch_size=args.batch_size, shuffle=True, num_workers=2,normalize=args.normalize_input_image)

    test_loader = torch.utils.data.DataLoader(testset, batch_size=args.batch_size, shuffle=True, num_workers=2,normalize=args.normalize_input_image)

    val_loader = torch.utils.data.DataLoader(valset, batch_size=args.batch_size, shuffle=True, num_workers=2,normalize=args.normalize_input_image)
