...
def train_test_val_dataset(dataset, test_split=0.1, val_split=0.1, random_state=1):
    train_init_idx, test_idx = train_test_split(list(range(len(dataset))), test_split, random_state)
    train_idx, val_idx = train_test_split(list(range(len(train_init_idx))), val_split, random_state)
